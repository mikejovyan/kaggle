...
| Episode | Title | Metric | Best model | Private score | Leaderboard score |
|---------|-------|--------|------------|---------------|-------------------|
...
| [s3e22](https://www.kaggle.com/competitions/playground-series-s3e22) | [Predict Health Outcomes of Horses](s3e22/) | F1-micro | Gradient Boosting | 0.742 | 0.782 |
